...
msi: build fmt
	wixl -a x64 -D VERSION=$(VERSION) -D iconPath=./packaging/sigsci.ico -D appPath=./packaging/agent-autoupdate.exe -o ./packaging/agent-autoupdate-$(VERSION).msi ./packaging/installer.wxs
